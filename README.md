...
<img width="1143" height="815" alt="image" src="https://github.com/user-attachments/assets/5108e754-585b-41ff-a4f9-5ac56bde7360" />

На компонентном уровне система CarDeal детализируется как набор логически выделенных модулей внутри Backend, каждый из которых реализует отдельную часть бизнес-логики.
